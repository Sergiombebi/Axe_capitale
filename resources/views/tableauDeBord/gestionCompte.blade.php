                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead style="background: #f7fafc;">
                        <tr>
                            ...
                            <th style="padding: 15px; text-align: left; font-weight: 600; color: #2d3748; border-bottom: 2px solid #e2e8f0;">Date Création</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #e2e8f0; transition: all 0.3s;" onmouseover="this.style.backgroundColor='#f7fafc'" onmouseout="this.style.backgroundColor='white'">
                            ...
                            <td style="padding: 15px;">
                                <div style="font-weight: 600; color: #2d3748;">{{ \Carbon\Carbon::parse($compte->created_at)->format('d/m/Y') }}</div>
                                <div style="font-size: 0.9rem; color: #718096;">{{ \Carbon\Carbon::parse($compte->created_at)->format('H:i') }}</div>
                                <div style="font-size: 0.8rem; color: #a0aec0;">{{ \Carbon\Carbon::parse($compte->created_at)->diffForHumans() }}</div>
                            </td>
...
function voirDetails(id) {
    window.open(`/gestionnaire/comptes/${id}/details`, '_blank');
}
