        ...
        <aside class="sidebar-fixed w-64 bg-white shadow-lg border-r border-gray-200 sidebar-mobile md:translate-x-0" id="sidebar">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                    <div class="space-y-1">
                        <a href="{{route('dashboard')}}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200">
